####################################################################################
# Plot Australia maps for RCP2.6 scenario
# 2006 PFT and % coverage across RCP2.6 models
# 2100 PFT and % coverage across RCP2.6 models

All_RCP26_plot <- function(sourceDir, destDir) {
    
    # create destination directory
    dir.create(destDir, showWarnings = FALSE)
    
    # RCP 2.6 files
    file.list <- c("IPSL-CM5A-LR_rcp26",
                   "IPSL-CM5A-MR_rcp26",
                   "MIROC-ESM_rcp26",
                   "MIROC-ESM-CHEM_rcp26",
                   "MPI-ESM-LR_rcp26",
                   "MPI-ESM-MR_rcp26")
    
    # create file paths
    source <- paste0(sourceDir, file.list, "/")
    ...
    # generate % difference for dominant plant between 2006 and 2100
    diffDF <- 
